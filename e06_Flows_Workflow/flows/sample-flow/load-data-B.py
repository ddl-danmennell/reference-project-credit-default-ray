...
parser.add_argument('--data_path', type=str, default='/mnt/code/e06_Flows_Workflow/data/datasetB.csv', help='Path to the input data. Only used during local testing. Flow triggered jobs will use task inputs.')
